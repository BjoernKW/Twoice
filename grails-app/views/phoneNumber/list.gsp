                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th><g:message code="phoneNumber.person.label" default="Person" /></th>
                        
                            <g:sortableColumn property="value" title="${message(code: 'phoneNumber.value.label', default: 'Value')}" />
                    ...
                    <g:each in="${phoneNumberInstanceList}" status="i" var="phoneNumberInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: phoneNumberInstance, field: "person")}</td>
                        
                            <td>${fieldValue(bean: phoneNumberInstance, field: "value")}</td>
