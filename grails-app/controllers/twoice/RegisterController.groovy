...
class RegisterController extends grails.plugins.springsecurity.ui.RegisterController {
	...
	static final twoicePasswordValidator = { String password, command ->
...
class RegisterCommand {
	...
	static constraints = {
		...
		password blank: false, minSize: 6, maxSize: 64, validator: RegisterController.twoicePasswordValidator
